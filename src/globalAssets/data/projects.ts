...
const projects = [
  ...
  },
  {
    ...
    desc: `A CRA Alternative. Set up to have different 'flavors', represented in the projects branches.`,
    tech: 'ReactJS, Webpack 5, Babel 7, TypeScript, ESLint, Styled-Components, Jest, React Testing Library',
  ...
  },
  {
    ...
    image: require('globalAssets/images/projects/portfolio_rebuild.png'),
    desc: 'This is a Portfolio rebuild from 2019. Site was updated, code reviewed and updated.',
    tech: 'ReactJS, Styled-Components, React-Helmet, React Router',
    git: 'https://github.com/karlchvojka/2019_portfolio'
  },
  {
    title: 'Weather App',
    image: require('globalAssets/images/projects/weather.png'),
    desc: 'This project was used specifically for practice passing props, and interacting with a third party API',
    tech: 'ReactJS',
